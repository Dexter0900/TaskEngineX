// src/components/sidebars/WorkerSidebar.tsx
...
export default function WorkerSidebar({ workspaceId, onLogout }: WorkerSidebarProps) {
  ...
  // Worker ke liye minimal menu items (read-only mostly)
