// src/components/sidebars/AssignerSidebar.tsx
...
interface AssignerSidebarProps {
  workspaceId: string;
  onLogout?: () => void;
}

export default function AssignerSidebar({
  workspaceId,
  onLogout,
}: AssignerSidebarProps) {
  ...
  // Assigner ke liye menu items (limited access)
